...
#define NODE_MAIN_LOGGER_NAME "new_armor_tracker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libnew_armor_tracker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_auto_aim::NewTrackerNode>";
